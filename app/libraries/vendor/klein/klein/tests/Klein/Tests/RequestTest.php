...
class RequestTest extends AbstractKleinTest
{
    ...
    public function testUniversalParams()
    {
        ...
        $cookies     = array('users' => 'Rican7', 'PHPSESSID' => 'randomstring', 'num' => 3, 4 => 'dog');
    ...
    public function testUniversalParamsWithFilter()
    {
        ...
        $filter      = array('page', 'users', 'num', 'this-key-never-showed-up-anywhere');
        $expected    = array('page' => 2, 'users' => 'Rican7', 'num' => 3, 'this-key-never-showed-up-anywhere' => null);
