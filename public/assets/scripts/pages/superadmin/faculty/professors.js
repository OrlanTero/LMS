...
const TARGET = "professors";
const MINI_TARGET = "professor";
const MAIN_TITLE = "Professor";
...
function ViewRequest(id) {
    ...
    popup.Create().then(((pop) => {
        ...
        const main_course_id = pop.ELEMENT.querySelector(".main_course_id");

        let selected_user;

        ListenToForm(form, function (data) {
            data.user_id = selected_user.user_id;
            data.main_course_id = GetComboValue(main_course_id).value
