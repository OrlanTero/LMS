...
export class AlertPopup {
    ...
    AddListeners(listeners = {onYes: null, onNo: null, onCancel: null, onShow: null, onHide: null, onClose: null}) {
        this.LISTENERS = {
            ...listeners,
            ...this.LISTENERS
        }
    ...
    Listeners() {
        if (this.PARENT && this.ELEMENT) {
            ...
            const closeBt = this.ELEMENT.querySelector(".close-btn");
            ...
            if (closeBtn) {
                closeBtn.addEventListener("click", () => {
                    ExecuteFn(this.LISTENERS, "onClose");
